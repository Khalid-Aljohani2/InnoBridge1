...
const content = {
    ar: {
        ...
        joinUs: 'سجل دخولك',
        joinUsHint: 'سجّل دخولك من هذا الزر. لتسجيل حساب جديد، اختر نوع الحساب من البطاقة أعلاه.',
    ...
    en: {
        ...
        joinUs: 'Sign in',
        joinUsHint: 'Sign in via this button. To create a new account, choose your role from a card above.',
