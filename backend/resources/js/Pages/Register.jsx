...
export default function Register() {
    ...
    return (
        <GuestLayout>
            <Head title="Register - Smart R&D" />

            <div className="mb-5">
                <h1 className="sr-section-title text-slate-900 dark:text-slate-100">Create account</h1>
                <p className="sr-muted mt-1">Set your role and start collaborating.</p>
            </div>
            ...
            <form onSubmit={submit} className="sr-section-stack">
                ...
                {/* Account Type - Role */}
                <div className="mt-4">
                    <InputLabel htmlFor="role" value="Register As (User Role)" />
                    <select
                        id="role"
                        name="role"
                        value={data.role}
                    ...
                    >
                        ...
                        <option value="industry">Industrial Partner (Industry)</option>
                    </select>
